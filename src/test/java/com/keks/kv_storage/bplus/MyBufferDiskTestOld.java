...
public class MyBufferDiskTestOld {
//
...
//        tableDir.mkdir();
//        DataPageManager dataPageManager = new DataPageManager(tableDir, myBuffer, new BPlusEngineConf(3, 10, 10));
//
...
//    // just using buffer
//    @Test
//    public void test2(@TempDir Path dir) throws Exception {
...
//                   CachedPageNew<SlottedPage> cachedPage = dataPageManager.getAndLockWriteFreePage();
//                    long freePageId = cachedPage.pageId;
////                    System.out.println("FreePageId: " + freePageId);
//                    SlottedPage page = cachedPage.getPage();
//                    String key = "key" + i;
//                    String value = "value" + i;
//
...
//                }
//            };
//            Time.withTime("put", () -> runConcurrentTest(records, 1000, 1, func, numberOfThreads));
...
//            };
//
//            Time.withTime("get", () -> runConcurrentTest(records, 1000, 1, func, numberOfThreads));
...
//    @Test
////    @RepeatedTest(10)
//    public void test4(@TempDir Path dir) throws Exception {
